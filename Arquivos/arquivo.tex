...
\begin{document}
	...
	Sendo assim, cada funcionário desempenha funções específicas, como coordenação administrativa, controle financeiro, planejamento orçamentário, suporte em tecnologia e gestão de recursos materiais, podendo assim garantir o funcionamento da secretaria. Infere-se, portanto, que toda a estrutura da Superintendência Administrativa de Orçamento, Finanças e Contabilidade possibilita uma organização eficiente dos recursos para o desenvolvimento das atividades realizadas na Secretaria de Estado do Turismo.
